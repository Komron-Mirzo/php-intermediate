    ...
    <div class="container-50 user-left content">
        ...
        <form action="" method="POST">
            ...
            <div class="form-field">
                ...
                <input type="text" name="user_name" id="user_name" value="<?php echo $current_user['username'] ?>" required>
            </div>
            <div class="form-field">
                <label for="user_email">Email</label>
                <input type="text" name="user_email" id="user_email" value="<?php echo $current_user['email'] ?>" required>
            </div>
